<template>
	...
	<section class="section section__single-resource">
		<div class="columns" >
			<div class="column is-three-fifths is-offset-one-fifth" style="background-color: white;">
				...
				<ol class="resource__bullets">
					<li v-for="item in post.meta_box._casestudy_list" :key="item['_resource_list_headline']">
		...
		<div class="rec-link" v-if="post.meta_box._casestudy_links != undefined">
			<h3>Recommended Links</h3>
			<ul class="resource__rec-link__list">
				<li v-for="link in post.meta_box._casestudy_links" :key="link['_casestudy_link_headline']">
					<h4 v-html="link['_casestudy_link_headline']"></h4>
					<p>{{ link['_casestudy_link_type'] }} | {{ link['_casestudy_link_author'] }}</p>
					<a v-if="link['_casestudy_link_file_upload'] != undefined" class="button button--ghost button--orange" :href="link['_casestudy_link_file_upload']" target="_blank">Click to download</a>
					<a v-else class="button button--ghost button--orange" :href="link['_casestudy_link_url']" target="_blank">Visit Article</a>
				</li>
			</ul>
		</div>
	</section>
